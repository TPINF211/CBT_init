...
public class ToursPanel extends JPanel {
    ...
    public ToursPanel() {
        ...
        JLabel infoLabel = new JLabel("En tant que Caissier, vous gérez les tours de tontine");
        ...
        // Table
        String[] columns = {"ID", "ID Groupe", "ID Bénéficiaire", "Numéro Tour", "Montant", "Date"};
